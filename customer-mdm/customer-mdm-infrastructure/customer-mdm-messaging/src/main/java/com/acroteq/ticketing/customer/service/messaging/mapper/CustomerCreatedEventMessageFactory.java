...
public interface CustomerCreatedEventMessageFactory
    extends EventToMessageMapper<CustomerCreatedEvent, CustomerCreatedEventMessage> {
  ...
  @Override
  CustomerCreatedEventMessage convertEventToMessage(CustomerCreatedEvent event);
}
