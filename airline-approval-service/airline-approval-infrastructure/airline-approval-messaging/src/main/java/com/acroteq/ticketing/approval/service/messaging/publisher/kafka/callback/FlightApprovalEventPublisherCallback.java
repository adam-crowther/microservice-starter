package com.acroteq.ticketing.approval.service.messaging.publisher.kafka.callback;
...
@Slf4j
@Component
public class FlightApprovalEventPublisherCallback {
  ...
  public <T extends SpecificRecordBase> BiFunction<SendResult<String, T>, Throwable, SendResult<String, T>> getHandler(
    ...
    return (sendResult, exception) -> callback(requestTopicName, message, orderId, messageType, sendResult, exception);
  }
