...
public abstract class FlightMapper
    implements MessageToDomainMapper<Flight, com.acroteq.ticketing.approval.service.domain.entity.airline.Flight> {

  @Mapping(target = "price.currencyId", source = "flight.priceCurrencyId")
  @Mapping(target = "price.amount", source = "flight.priceAmount")
  @Override
  public abstract com.acroteq.ticketing.approval.service.domain.entity.airline.Flight convert(
      Flight flight,
      EventId eventId);

  public List<com.acroteq.ticketing.approval.service.domain.entity.airline.Flight> convert(
  ...
  private Function<Flight, com.acroteq.ticketing.approval.service.domain.entity.airline.Flight> convert(
