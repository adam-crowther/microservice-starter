...
class CashValueSpec extends Specification {
  ...
  def 'when created with all attributes it should return the values correctly'() {
    ...
    then:
    cashValue.currencyId == CURRENCY_CHF
    cashValue.amount == AMOUNT
  }
  ...
  def 'isGreaterThan should throw an exception if the 2 currencies do not match'() {
    given:
    def value = CashValue.builder()
          .currencyId(currencyId)
          .amount(BigDecimal.valueOf(amount))
  ...
  def 'isGreaterThanOrEqualTo should throw an exception if the 2 currencies do not match '() {
    given:
    def value = CashValue.builder()
          .currencyId(currencyId)
          .amount(BigDecimal.valueOf(amount))
  ...
  def 'isLessThan should throw an exception if the 2 currencies do not match '() {
    given:
    def value = CashValue.builder()
          .currencyId(currencyId)
          .amount(BigDecimal.valueOf(amount))
  ...
  def 'isLessThanOrEqualTo should throw an exception if the 2 currencies do not match '() {
    given:
    def value = CashValue.builder()
          .currencyId(currencyId)
          .amount(BigDecimal.valueOf(amount))
  ...
  def 'add should return a new cash value containing the sum of the 2 amounts'() {
    ...
    then:
    sum.amount == expectedAmount
    sum.currencyId == expectedCurrency
  ...
  def 'add should throw an exception if the 2 currencies do not match '() {
    given:
    def value = CashValue.builder()
          .currencyId(currencyId)
          .amount(BigDecimal.valueOf(amount))
  ...
  def 'subtract should throw an exception if the 2 currencies do not match '() {
    given:
    def value = CashValue.builder()
          .currencyId(currencyId)
          .amount(BigDecimal.valueOf(amount))
  ...
  def 'multiply should return a new cash value containing the product of the 2 amounts'() {
    ...
    when:
    def product = value * quantity

    then:
    product.amount == expectedAmount
    product.currencyId == CURRENCY_CHF
