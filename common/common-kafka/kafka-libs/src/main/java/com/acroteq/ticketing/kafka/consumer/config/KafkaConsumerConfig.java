...
import com.acroteq.ticketing.kafka.config.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
  ...
  private Map<String, Object> createKafkaConsumerConfigMap() {
    final int maxPartitionFetchBytes = kafkaConsumerConfigData.getMaxPartitionFetchBytesDefault()
