package com.acroteq.ticketing.customer.service.messaging.publisher.kafka.callback;
...
public class EventPublisherCallback {
  ...
  private <T extends SpecificRecordBase> SendResult<String, T> callback(final String requestTopicName,
    ...
    if (exception == null) {
      ...
      log.info(
          "Received response from Kafka for {} for customer Id {}" + " Topic {}, Partition {}, Offset {}, Timestamp {}",
          messageType,
          customerId,
          metadata.topic(),
          metadata.partition(),
